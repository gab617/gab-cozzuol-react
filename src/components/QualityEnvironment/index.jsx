    ...
    return(
        <div id="QualityEnvironment" className='fade-in'>
            <div id='quality-title'>
                <img src="/images/quality-environment/environment_tit.png" alt="" />
            </div>
            <div id='quality-info-cont'>
                <div className='quality-info'>
                    <img src="/images/quality-environment/calidad_medio_img01.png" alt="" />
                ...
                <div className='quality-info'>
                    <img src="/images/quality-environment/calidad_medio_img02.png" alt="" />
            ...
            <div id='certifications'>
                ...
                <div>
                    <div className='certif-data'>
                        <img src="/images/quality-environment/flecha_roja.png" alt="" />
                        <h3>ISO TS 16949</h3>
                    </div>
                    <div className='certif-data'>
                        <img src="/images/quality-environment/flecha_roja.png" alt="" />
